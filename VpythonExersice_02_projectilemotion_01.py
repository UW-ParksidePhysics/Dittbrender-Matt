...
initial_velocity = float(input("How much 'Yeet' put into the throw? (Recommendation:10) "))
θ = float(input("What is the angle of trajectory in degrees? (Recommendation:30°) "))
θ = θ * (pi / 180)
earth_θ = θ
mars_θ = θ
moon_θ = θ
