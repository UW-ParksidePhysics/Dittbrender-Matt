from vpython import vector, color, scene, cylinder, label, arrow
...
r = arrow(pos=vector(12, 8, 2), axis=vector(0, 0, 0), color=color.purple, shaftwidth=0.3, )
rlbl = label(pos=vector(12, 8, 2), text="Birthday Numbers", color=color.blue, opacity=0, height=30, box=0)
